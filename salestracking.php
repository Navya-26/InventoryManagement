...
@media screen and (max-width: 600px) {
  .col-25, .col-75,.header,.col-middle,input[type=submit] ,img,table{
    width: 100%;
    margin-top: 0;
  }
}
...
<center>
  ...
  <a href="#" class="active">Sales Tracking</a>
  <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
</div><h1><b><i>Inventory Tracking</i></b></h1></center>
 <br>
   <div class="table-responsive">
   <div style="overflow-x:auto;">
    <table id="product_data" class="table table-bordered table-striped col-middle">
     <thead>
      <tr>
       <th>Id</th>
	   <th>Invoice No</th>
       ...
       <th>
        <select name="date" id="date" class="form-control">
         <option value="">Date search</option>
         <?php 
